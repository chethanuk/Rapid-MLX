...
class Context:
    ...
    @property
    def is_mergify_merge_candidate(self) -> bool:
        """True only for a merge candidate generated by the Mergify app.

        Mergify candidates carry a machine-generated body containing live
        queue-condition checklists, not an author's test plan or change
        description. Require both GitHub's verified app login and Mergify's
